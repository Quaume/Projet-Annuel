...
<div class="container-fluid mt-1">
 ...
 <div class="row header text-center form-group">
     ...
     <div class="col-lg-4 col-sm-6 col-12 commoncontainer">
         ...
         <input type="email" name="email" class="form-control-md text-center mt-3 formsbtns px-5 py-1" placeholder="Email" required="required"><br>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Click On The Squares To Change Their Color</h5>
